...
class fgds_file_handle:
    def __init__(self, filename: str, o_direct: bool, device_id: int) -> None: ...
    def get_device_id(self) -> int: ...
    def get_fd(self) -> int: ...

class fgds_device_buffer:
    def __init__(self, dev_ptr: int, length: int) -> None: ...
    def get_base_address(self) -> int: ...
    def get_length(self) -> int: ...

class fgds_file_reader:
    def __init__(self, max_threads: int, device_id: int) -> None: ...
    def submit_read(
        self,
        fh: fgds_file_handle,
...
def init_gds() -> int: ...
def close_gds() -> int: ...
def is_fgds_found() -> bool: ...
def init_fgds(device_id: int) -> int: ...
def close_fgds(device_id: int) -> int: ...
def fgds_regmem(device_id: int, addr: int, size: int, target_addr: object) -> int: ...
