...
// dlopen() in load_library_functions(), same as cuFile/hipFile above.
...
// load_library_functions(); is_fgds_found() reports whether they are available.
// init_fgds()/close_fgds() manage per-device fgds_open/fgds_close explicitly,
// mirroring the GDS init_gds()/close_gds() model.
bool is_fgds_found();
